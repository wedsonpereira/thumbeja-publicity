...
import '../../../index.css'
import VideoMarketingImg from '../../../assets/Images/VideoMarketing.png';
        ...
        <div className="DigitalMarketing max-width-[2000px] min-h-[60rem]">
            ...
            <div className="DigitalMarketingbox1 max-w-300  m-auto ">
                <h1 className="heading pt-[4rem] pl-[2.5rem] "
                    style={{textAlign: 'left', fontWeight: 'bold', fontSize: "2.3rem"}}> Video Marketing</h1>
            ...
            <div className="ImageSection pt-10 max-width-[2000px] min-h-[14rem] ">
                <img src={VideoMarketingImg} className="DigitalMarketingImg w-[90%] rounded-2xl mt-0 mb-0 m-auto"
