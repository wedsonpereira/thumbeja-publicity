...
import '../../../index.css'
import CustomerRelationshipManagementImg from '../../../assets/Images/CustomerRelationshipManagement.png';
    ...
    return (
        <div className="DigitalMarketing max-width-[2000px] min-h-[60rem]">
            ...
            <div className="ImageSection pt-10 max-width-[2000px] min-h-[14rem] ">
                <img src={CustomerRelationshipManagementImg} className="DigitalMarketingImg  rounded-2xl mt-0 mb-0 m-auto"
